...
```CSHARP
rateManager.AddProvider(new UPSProvider(upsUserId, "UPS Ground"));
rateManager.AddProvider(new USPSProvider(uspsLicenseNumber, upsUserId, upsPassword, "Priority Mail"));
````
